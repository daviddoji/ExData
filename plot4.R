...
# Set transparent background and plot Graph 4
par(bg = NA, mfrow=c(2, 2))
# Subplot 1
plot(datetimes, df$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")
# Subplot 2
plot(datetimes, df$Voltage, type = "l", ylab = "Voltage")
# Subplot 3
